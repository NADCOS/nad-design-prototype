...
export default function MaterialCard({ name, isRecommended, recommendedLabel, badgeSide, slotId, prefillSrc, isAdmin, overrideUrl, onAdminImageChange, editLabel, chosen, onSelect, onHover }) {
