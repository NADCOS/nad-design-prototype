...
export default function EditableImage({ slotId, placeholder, prefillSrc, isAdmin, overrideUrl, onAdminImageChange, aspect, editLabel, stopClickPropagation, onEditClick, onImageError }) {
  return (
