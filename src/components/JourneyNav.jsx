  ...
  const previewThumb = showThumb && (
    <div style={{ position: 'relative', flexShrink: 0 }}>
      <Hoverable
        ...
        style="position:relative;width:50px;height:50px;border-radius:14px;padding:0;border:1px solid var(--border);cursor:pointer;background:transparent;flex-shrink:0;transition:transform .18s ease;"
