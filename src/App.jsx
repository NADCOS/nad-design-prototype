...
function Shell() {
  ...
  const themeVars = isDark
    ? { '--bg': 'oklch(16% 0.02 50)', '--nav-bg': 'oklch(16% 0.02 50 / 0.9)', '--surface': 'oklch(22% 0.015 50)', '--text': 'oklch(92% 0.01 80)', '--text-2': 'oklch(70% 0.02 70)', '--border': 'oklch(32% 0.02 55)', '--btn-bg': 'oklch(90% 0.02 75)', '--btn-text': 'oklch(18% 0.02 50)' }
    : { '--bg': 'oklch(97% 0.015 80)', '--nav-bg': 'oklch(97% 0.015 80 / 0.9)', '--surface': '#fff', '--text': 'oklch(24% 0.02 55)', '--text-2': 'oklch(46% 0.02 55)', '--border': 'oklch(87% 0.02 70)', '--btn-bg': 'oklch(24% 0.02 55)', '--btn-text': 'oklch(98% 0.01 80)' };
